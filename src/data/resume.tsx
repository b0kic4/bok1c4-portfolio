...
export const DATA = {
  ...
  summary:
    "I’ve been passionate about programming since early age. I started exploring coding around 2017, and by the end of 2021, I wrote my first React code. Initially, I learned JavaScript, HTML, and CSS through tutorials, building simple websites. As I gained knowledge, I created my own E-commerce sites, blogs, and basic websites. By late 2022, I dived into Node.js and TypeScript, fostering a growing interest in backend development and exploring new technologies and languages like Python and C. With increasing confidence, I built websites with React, Node.js, MongoDB, and aslo developed some applications in Python. Fast forward two years, I have learned TypeScript, Java, Go, and JavaScript frameworks like NestJS and NextJS. I deepened my programming knowledge by reading books, creating software, watching courses, and learning from other people's code. Since then, I’ve focused on enhancing my skills in software design, architecture, distributed systems, databases, and algorithms & data structures.",
